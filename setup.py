#!/usr/bin/env python
"""
Package metadata for list_and_filter.
"""
import os
import re
import sys
...
VERSION = get_version('list_and_filter', '__init__.py')
...
setup(
    ...
    author='Talha Rizwan Malik',
    author_email='talharizwan667@gmail.com',
    url='https://github.com/openedx/openedx_django_app',
    packages=find_packages(
        include=['list_and_filter', 'list_and_filter.*'],
        exclude=["*tests"],
    ),
