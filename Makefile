...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd list_and_filter && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd list_and_filter && i18n_tool generate

detect_changed_source_translations:
	cd list_and_filter && i18n_tool changed
...
pull_translations:
	find list_and_filter/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/openedx_django_app/list_and_filter/conf/locale:list_and_filter/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd list_and_filter && i18n_tool dummy
