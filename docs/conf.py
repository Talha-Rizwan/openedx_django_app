...
"""
list_filter documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx_django_app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/openedx_django_app",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'list_and_filter'),
                os.path.join(root_path, 'list_and_filter/migrations')])
